...
class Openid_model3
{
    ...
    protected 	$server,
				...
				$xrds_override_pattern = null,
				$xrds_override_replacement = null;
    ...
    {	// Здесь устанавливается имя домена для обратного перенаправления после Логина в Steam
		log_message('debug', '=== Construct of OpenID_Model :: Begin');
		$dbg = get_instance()->config->item('domainname');
		log_message('debug', '=== Construct of OpenID_Model :: domainname = '.$dbg);
		...
		log_message('debug', '=== Construct of OpenID_Model :: End');
    }
